namespace GeniusIdiotConsoleApp
{
    internal class Program
    {
        ...
        private static void TeacherLogin(List<StudentResult> students, List<Question> questions)
        {
        ...
        private static void TeacherMenu(List<StudentResult> students, List<Question> questions)
        {
            bool isRunning = true;
            while (isRunning)
            {
        ...
        private static void ShowGroupStatistics(List<StudentResult> students)
        {
        ...
        private static void ShowQuestionsAnswers(List<Question> questions)
        {
        ...
        private static void Test(List<StudentResult> students, List<Question> questions, List<Diagnosis> diagnoses)
        {
        ...
        private static void FillQuestions(List<Question> questions)
        {
        ...
        private static void FillDiagnoses(List<Diagnosis> diagnoses)
        {
